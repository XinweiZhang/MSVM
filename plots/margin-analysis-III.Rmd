...
## sep = 1
```{r echo=F, fig.height=9, fig.width=15, warning=FALSE}
set.seed(123)
n = 3000
train_data <- generate_noise_three_filled_circle(n, sep = 1)
...
# Design 4, Gaussian, probability 2
## sep = 1.9
```{r, fig.width=15, fig.height=9, warning=FALSE, echo=F}
...
# Design 4, Gaussian, probability 3
## sep = 1.9
```{r, fig.width=15, fig.height=9, warning=FALSE, echo=F}
