...
```{r, fig.width=15, fig.height=12, warning=FALSE, echo=F}
n = 3000
train_data <- generate_noise_three_circle(n, sep = 0.5)
plot_batch(train_data)
```
...
# Design 4, Gaussian, probability 1
...
```{r, fig.width=15, fig.height=12, warning=FALSE, echo=F}
n = 3000
train_data <- generate_noise_three_gaussian(n, sep = 0.5)
plot_batch(train_data)
```
