---
title: "Four Class Circle Classification"
author: "Xinwei"
date: "7/4/2020"
output: 
  html_document:
...
new1_models_b1 <- lapply(C_list, function(C){New1_pri_opt(X,y,C,intercept = F, base_class = 1)})
new1_models_b2 <- lapply(C_list, function(C){New1_pri_opt(X,y,C,intercept = F, base_class = 2)})
new1_models_b3 <- lapply(C_list, function(C){New1_pri_opt(X,y,C,intercept = F, base_class = 3)})
new1_models_b4 <- lapply(C_list, function(C){New1_pri_opt(X,y,C,intercept = F, base_class = 4)})
...
new3_models_b1 <- lapply(C_list, function(C){New3_pri_opt(X,y,C,intercept = F, base_class = 1)})
new3_models_b2 <- lapply(C_list, function(C){New3_pri_opt(X,y,C,intercept = F, base_class = 2)})
new3_models_b3 <- lapply(C_list, function(C){New3_pri_opt(X,y,C,intercept = F, base_class = 3)})
new3_models_b4 <- lapply(C_list, function(C){New3_pri_opt(X,y,C,intercept = F, base_class = 4)})
...
g12 <- NULL
msvm_models_b1 <- lapply(C_list, function(C){MSVM7_pri_opt(X,y,C,intercept = F, base_class = 1)})
msvm_models_b2 <- lapply(C_list, function(C){MSVM7_pri_opt(X,y,C,intercept = F, base_class = 2)})
msvm_models_b3 <- lapply(C_list, function(C){MSVM7_pri_opt(X,y,C,intercept = F, base_class = 3)})
msvm_models_b4 <- lapply(C_list, function(C){MSVM7_pri_opt(X,y,C,intercept = F, base_class = 4)})
