...
generate_asy_noise_y <- function(y, noise_level){
  ...
  y_fake <- sapply(idx, function(x){
    if(y[x]==1){
      sample(c(1,2,3,4), size =1, prob = c(.3,.26,.24,.20))
    }else if(y[x]==2){
      sample(c(1,2,3,4), size =1, prob = c(.28,.32,.3,.1))
    }else if(y[x]==3){
      sample(c(1,2,3,4), size =1, prob = c(.18, .24, .32, .26))
    }else if(y[x]==4){
      sample(c(1,2,3,4), size =1, prob = c(.28, .22, .2, .3))
    }
  })
...
cprob1 <- c(1-noise_level + noise_level*.3, noise_level*.26, noise_level*.24, noise_level*.20)
cprob2 <- c(noise_level*.28, 1-noise_level + noise_level*.32, noise_level*.3, noise_level*.1)
cprob3 <- c(noise_level*.18, noise_level*.24, 1-noise_level + noise_level*.32, noise_level*.26)
cprob4 <- c(noise_level*.28, noise_level*.22, noise_level*.2, 1-noise_level + noise_level*.3)
c(sum(cprob1), sum(cprob2), sum(cprob3), sum(cprob4))
rbind(cprob1,cprob2,cprob3,cprob4)
...
cprob1 <- c(1-noise_level + noise_level*.3, noise_level*.26, noise_level*.24, noise_level*.20)
cprob2 <- c(noise_level*.28, 1-noise_level + noise_level*.32, noise_level*.3, noise_level*.1)
cprob3 <- c(noise_level*.10, noise_level*.24, 1-noise_level + noise_level*.4, noise_level*.26)
cprob4 <- c(noise_level*.28, noise_level*.22, noise_level*.2, 1-noise_level + noise_level*.3)
c(sum(cprob1), sum(cprob2), sum(cprob3), sum(cprob4))
rbind(cprob1,cprob2,cprob3,cprob4)
